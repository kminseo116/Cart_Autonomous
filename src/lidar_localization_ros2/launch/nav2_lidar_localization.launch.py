...
def generate_launch_description():
    ...
    registration_method = LaunchConfiguration(
        'registration_method', default='NDT_OMP')
    ...
    ld.add_action(DeclareLaunchArgument('registration_method', default_value='NDT_OMP'))
