...
def _start_localization(context, *args, **kwargs):
    ...
    use_imu_preintegration = LaunchConfiguration("use_imu_preintegration").perform(context)
...
def generate_launch_description():
    ...
    default_localization_params = os.path.join(
        package_share, "param", "mid360_legged_small_gicp_no_timer.yaml"
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("localizer_enable_timer_publishing", default_value="false"),
